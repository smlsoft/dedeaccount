...
export default {
  ...
  inheritAttrs: false,
  emits: ["update:modelValue", "input", "focus", "blur", "enter" , "arrow-up", "arrow-down", "arrow-left", "arrow-right"],
  props: {
    modelValue: {
      type: Number,
      default: null,
  ...
  methods: {
    ...
    onInputKeyDown(event) {
      ...
      switch (event.which) {
        // Up arrow
        case 38:
          // Stop default behavior to prevent cursor movement within the input
          event.preventDefault();
        ...
        // Left arrow
        case 37:
          // Only handle left navigation if at the beginning of the field
          if (selectionStart === 0) {
            event.preventDefault();
            this.$emit("arrow-left");
          }
          break;

        // Right arrow
        case 39:
          // Only handle right navigation if at the end of the field
          if (selectionStart === inputValue.length) {
            event.preventDefault();
            this.$emit("arrow-right");
          }
          break;
