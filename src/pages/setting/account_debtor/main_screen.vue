...
<template>
      ...
      <Splitter style="height: 100vh">
        <SplitterPanel :minSize="30">
          <dataList
            ...
            v-on:debtorCodeFocus="createDebtor"
            v-on:onRowSelect="onRowSelect"
            v-on:editDebtor="editDebtor"
            v-on:deleteDebtor="deleteDebtor"
            v-on:onPage="onPage"
        ...
        <SplitterPanel :minSize="30">
          <dataForm
            ...
            :debtorCodeFocus="debtorCodeFocus"
            :readMode="readMode"
            v-on:unFocusDebtorCode="unFocusDebtorCode"
            v-on:onSave="onSave"
          ></dataForm>
        </SplitterPanel>
      </Splitter>
  ...
  <DialogForm
    ...
    :textContent="'ต้องการบันทึกลูกหนี้'"
  ...
  <DialogForm
    ...
    :textContent="'ต้องการแก้ไขลูกหนี้'"
    :textContent2="form_model.name"
