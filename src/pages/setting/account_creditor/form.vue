...
<template>
  <div class="p-2">
    <Button :disabled="readMode" @click="onSave" label="บันทึกเจ้าหนี้" icon="pi pi-save"
      class="w-auto p-button-success btnSave"></Button>
  </div>
    ...
    <div class="grid formgrid mt-1 ">
      ...
      <div class="field col-6 md:col-12">
        <span class="p-float-label">
          <InputText :disabled="readMode" v-model="props.form_model.code"
            :class="!props.form_valid.code ? 'p-invalid ' : ''" class="code" @blur="unFocusCreditorCode"
      ...
      <div class="field col-6 md:col-12">
        <span class="p-float-label">
          <InputText :disabled="readMode" v-model="props.form_model.name"
            :class="!props.form_valid.name ? 'p-invalid ' : ''" class="name" @keyup.enter="headerNextFocus('taxid')" />
          <label>ชื่อเจ้าหนี้</label>
        </span>
      </div>

      <div class="field col-6 md:col-12">
        <input type="radio" id="naturalperson" name="personaltype" class="personaltype" value="0" :disabled="readMode"
          v-model="props.form_model.personaltype" :class="!props.form_valid.personaltype ? 'p-invalid ' : ''"
          @change="updatePersonalType(0)" />
        <label for="naturalperson">บุคคลธรรมดา</label>
        <input type="radio" id="juristicperson" name="personaltype" class="personaltype" value="1" :disabled="readMode"
          v-model="props.form_model.personaltype" :class="!props.form_valid.personaltype ? 'p-invalid ' : ''"
      ...
      <div class="field col-6 md:col-12">
        <span class="p-float-label">
          <InputText :disabled="readMode" v-model="props.form_model.taxid"
            :class="!props.form_valid.taxid ? 'p-invalid ' : ''" class="taxid"
      ...
      <div class="field col-6 md:col-12">
        <input type="radio" id="headbranch" name="customertype" class="customertype" value="0" :disabled="readMode"
          v-model="props.form_model.customertype" :class="!props.form_valid.customertype ? 'p-invalid ' : ''"
          @change="updateCustomertype(0)" />
        <label for="headbranch">สำนักงานใหญ่</label>
        <input type="radio" id="subbranch" name="customertype" class="customertype" value="1" :disabled="readMode"
          v-model="props.form_model.customertype" :class="!props.form_valid.customertype ? 'p-invalid ' : ''"
      ...
      <div class="field col-6 md:col-12">
        <span class="p-float-label">
          <InputText :disabled="readMode" v-model="props.form_model.address"
            :class="!props.form_valid.address ? 'p-invalid ' : ''" class="address"
      ...
      <div class="field col-6 md:col-12">
        <span class="p-float-label">
          <InputText maxlength="10" :disabled="readMode" v-model="props.form_model.phoneprimary"
            :class="!props.form_valid.phoneprimary ? 'p-invalid ' : ''" class="phoneprimary"
