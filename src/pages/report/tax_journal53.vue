      ...
      <div class="surface-card p-4 shadow-2 border-round">
        <div class="mb-3 flex align-items-center justify-content-between">
          <span class="text-xl font-medium text-900"
            >รายงานภาษี / ภาษีหัก ณ ที่จ่าย ภ.ง.ด.53</span
          >
            ...
            <table class="report-table">
              <thead>
                <tr>
                  ...
                  <th class="text-center">ภาษีที่นำส่งในครั้งนี้</th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="(item, index) in paginatedData" :key="item.id">
                  ...
                  <td class="text-center">{{ formatDateThai(item.taxdate) }}</td>
                  <td class="text-center">
                    {{
                      item.details && item.details[0]
...
onMounted(() => {
  ...
  storeApp.setPageTitle("รายงานภาษีหัก ณ ที่จ่าย ภ.ง.ด.53");
  storeApp.setActivePage("report_tax_list");
  storeApp.setActiveChild("report_tax_journal53");
});
</script>
