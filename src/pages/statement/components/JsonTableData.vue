...
function showNumIndex(index) {
  var totalRow = 0;
  if (props.pdfData) {
    totalRow = props.pdfData.length;
  }
  /// check index last row not show index
  if (index + 1 == totalRow) {
    return "";
  } else {
    return index + 1;
