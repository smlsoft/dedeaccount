...
<template>
    <AppLayout>
        <MainContentWarp @scroll="onScroll">
            ...
            <Card class="p-3" ref="content" @dragenter="onDragEnter" @dragover="onDragOver" @dragleave="onDragLeave"
                ...
                <template #content class="p-0">
                    ...
                    <div class="grid pt-0 mt-0">
                        <div class="col-12 md:col-6 lg:col-4 xl:col-3 pt-0" v-for="(data, index) in data_gallery"
                            :key="index">
                            <ImagesGallery :gallery_data="data" v-on:selectGallery="selectGallery"></ImagesGallery>
                        </div>
                        <div class="col-12 md:col-6 lg:col-4 xl:col-3 pt-0" v-for="data in data_list"
                            :key="data.guidfixed">
                            <ImageBlock :images_data="data" :images_selete="selectedImg" :allimage_used="AllImageUsed"
            ...
            <DialogForm :confirmDialog="createDialog" :textContent="create" v-on:close="onClose"
                v-on:confirm="onSaveCreate">
            </DialogForm>
            <Dialog v-model:visible="updateRefDialog" :style="{ width: '450px' }" header="กำหนดกลุ่มเอกสาร"
                :modal="true">
                ...
                <template #footer>
                    ...
                    <Button label="บันทึก" icon="pi pi-check" class="p-button-text" @click="postDocumentImageGroup()" />
                </template>
            </Dialog>
